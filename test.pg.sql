...
-- Origem: test_firebird.sql
-- Estratégia COMPUTED: generated
-- Estratégia DOMAINS: keep
...
-- Obs: Ajuste o caminho do -- CREATE DATABASE removido (criar manualmente no PostgreSQL)

/* =============================
   DOMÍNIOS BÁSICOS
   ============================= */
-- Domain convertido do Firebird
CREATE DOMAIN DM_ID AS BIGINT;
-- Domain convertido do Firebird
CREATE DOMAIN DM_FLAG AS SMALLINT;
-- Domain convertido do Firebird
CREATE DOMAIN DM_TEXTO_50 AS VARCHAR(50);
-- Domain convertido do Firebird
CREATE DOMAIN DM_TEXTO_80 AS VARCHAR(80);
-- Domain convertido do Firebird
CREATE DOMAIN DM_TEXTO_120 AS VARCHAR(120);
-- Domain convertido do Firebird
CREATE DOMAIN DM_TEXTO_255 AS VARCHAR(255);
-- Domain convertido do Firebird
CREATE DOMAIN DM_EMAIL AS VARCHAR(120);
-- Domain convertido do Firebird
...
-- Domain convertido do Firebird
CREATE DOMAIN DM_TIPO_PAGTO AS VARCHAR(20);
...
/* TODO: Converter trigger manualmente:
...
/* =============================
   ...
   ============================= */
/* TODO: Converter PROCEDURE manualmente:
